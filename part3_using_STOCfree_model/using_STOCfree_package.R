...
## ----JAGS model compilation, eval = TRUE------------------------------------------------------
compiled_model <- compile_JAGS(sfd,
                               n_chains = 4,
                               keep_model_file = TRUE)


## ----sampling from JAGS model, eval = TRUE----------------------------------------------------
...
## ----summary of distributions for predicted probabilities of infection------------------------
...
## ----add risk factors to STOCfree data--------------------------------------------------------
...
## ----set prior distributions risk factors-----------------------------------------------------
...
## ----display prior distributions risk factors-------------------------------------------------
show_rf(sfd)


## ----plot prior distributions risk factors, fig.height= 5-------------------------------------
plot_priors_rf(sfd)


## ----compiling JAGS model with risk factors---------------------------------------------------
compiled_model1 <- compile_JAGS(sfd,
                               n_chains = 4,
                               keep_model_file = TRUE)


## ----sampling from JAGS model with risk factors-----------------------------------------------
...
## ----saving results of model with risk factors------------------------------------------------
...
## ----parameters of model with risk factors----------------------------------------------------
...
## ---- fig.height = 5--------------------------------------------------------------------------
pinf1 <- as_tibble(read.csv("model_output/proba_inf.csv"))
